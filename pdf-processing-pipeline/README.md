...
You can then execute your native executable with: `./target/pdf-processing-pipeline-1.0.0-SNAPSHOT-runner`
...
- Antivirus ([guide](https://quarkiverse.github.io/quarkiverse-docs/quarkus-antivirus/dev/index.html)): Virus scan files using ICAP, ClamAV, or VirusTotal
