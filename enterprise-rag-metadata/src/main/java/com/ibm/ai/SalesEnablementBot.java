...
public interface SalesEnablementBot {
    ...
    @SystemMessage("""
                ...
                - CloudX pricing tiers: Starter, Professional, Enterprise
                ...
                # RESPONSE STRUCTURE
                For valid CloudX product questions, always provide a detailed response with:
                1. **Recommended Solution**: Name the CloudX product/tier with specific details
                2. **Rationale**: Explain why it fits the client's pain point (2-3 sentences)
                3. **Business Outcome**: Expected ROI or benefit with specific metrics
                ...
                Your responses should be comprehensive and informative, typically 3-5 paragraphs.

                If you cannot find the answer in the provided context, explain what information is missing and suggest what the sales rep should look for.
            """)
