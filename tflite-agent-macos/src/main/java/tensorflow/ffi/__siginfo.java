...
public class __siginfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        c_api_h.C_INT.withName("si_signo"),
        c_api_h.C_INT.withName("si_errno"),
        c_api_h.C_INT.withName("si_code"),
        c_api_h.C_INT.withName("si_pid"),
        c_api_h.C_INT.withName("si_uid"),
        c_api_h.C_INT.withName("si_status"),
        c_api_h.C_POINTER.withName("si_addr"),
        sigval.layout().withName("si_value"),
        c_api_h.C_LONG.withName("si_band"),
        MemoryLayout.sequenceLayout(7, c_api_h.C_LONG).withName("__pad")
    ).withName("__siginfo");
