...
public class rusage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        c_api_h.C_LONG.withName("ru_maxrss"),
        c_api_h.C_LONG.withName("ru_ixrss"),
        c_api_h.C_LONG.withName("ru_idrss"),
        c_api_h.C_LONG.withName("ru_isrss"),
        c_api_h.C_LONG.withName("ru_minflt"),
        c_api_h.C_LONG.withName("ru_majflt"),
        c_api_h.C_LONG.withName("ru_nswap"),
        c_api_h.C_LONG.withName("ru_inblock"),
        c_api_h.C_LONG.withName("ru_oublock"),
        c_api_h.C_LONG.withName("ru_msgsnd"),
        c_api_h.C_LONG.withName("ru_msgrcv"),
        c_api_h.C_LONG.withName("ru_nsignals"),
        c_api_h.C_LONG.withName("ru_nvcsw"),
        c_api_h.C_LONG.withName("ru_nivcsw")
    ).withName("rusage");
