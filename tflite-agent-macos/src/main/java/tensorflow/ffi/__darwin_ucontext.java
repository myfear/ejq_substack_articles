...
public class __darwin_ucontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        c_api_h.C_INT.withName("uc_onstack"),
        c_api_h.C_INT.withName("uc_sigmask"),
        __darwin_sigaltstack.layout().withName("uc_stack"),
        c_api_h.C_POINTER.withName("uc_link"),
        c_api_h.C_LONG.withName("uc_mcsize"),
        c_api_h.C_POINTER.withName("uc_mcontext")
