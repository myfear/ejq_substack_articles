...
public class __sigaction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        c_api_h.C_POINTER.withName("sa_tramp"),
        c_api_h.C_INT.withName("sa_mask"),
        c_api_h.C_INT.withName("sa_flags")
    ...
    public final static class sa_tramp {
        ...
        private static final MethodHandle UP$MH = c_api_h.upcallHandle(sa_tramp.Function.class, "apply", $DESC);
