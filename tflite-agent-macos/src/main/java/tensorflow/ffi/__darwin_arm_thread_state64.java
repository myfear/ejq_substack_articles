...
public class __darwin_arm_thread_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(29, c_api_h.C_LONG_LONG).withName("__x"),
        c_api_h.C_LONG_LONG.withName("__fp"),
        c_api_h.C_LONG_LONG.withName("__lr"),
        c_api_h.C_LONG_LONG.withName("__sp"),
        c_api_h.C_LONG_LONG.withName("__pc"),
        c_api_h.C_INT.withName("__cpsr"),
        c_api_h.C_INT.withName("__pad")
