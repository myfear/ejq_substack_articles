...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        c_api_h.C_POINTER.withName("__routine"),
        c_api_h.C_POINTER.withName("__arg"),
        c_api_h.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = c_api_h.upcallHandle(__routine.Function.class, "apply", $DESC);
