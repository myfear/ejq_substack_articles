...
public class __sigaction_u {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        c_api_h.C_POINTER.withName("__sa_handler"),
        c_api_h.C_POINTER.withName("__sa_sigaction")
    ...
    public final static class __sa_handler {
        ...
        private static final MethodHandle UP$MH = c_api_h.upcallHandle(__sa_handler.Function.class, "apply", $DESC);
    ...
    public final static class __sa_sigaction {
        ...
        private static final MethodHandle UP$MH = c_api_h.upcallHandle(__sa_sigaction.Function.class, "apply", $DESC);
