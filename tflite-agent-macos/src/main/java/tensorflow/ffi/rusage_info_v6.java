...
public class rusage_info_v6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, c_api_h.C_CHAR).withName("ri_uuid"),
        c_api_h.C_LONG_LONG.withName("ri_user_time"),
        c_api_h.C_LONG_LONG.withName("ri_system_time"),
        c_api_h.C_LONG_LONG.withName("ri_pkg_idle_wkups"),
        c_api_h.C_LONG_LONG.withName("ri_interrupt_wkups"),
        c_api_h.C_LONG_LONG.withName("ri_pageins"),
        c_api_h.C_LONG_LONG.withName("ri_wired_size"),
        c_api_h.C_LONG_LONG.withName("ri_resident_size"),
        c_api_h.C_LONG_LONG.withName("ri_phys_footprint"),
        c_api_h.C_LONG_LONG.withName("ri_proc_start_abstime"),
        c_api_h.C_LONG_LONG.withName("ri_proc_exit_abstime"),
        c_api_h.C_LONG_LONG.withName("ri_child_user_time"),
        c_api_h.C_LONG_LONG.withName("ri_child_system_time"),
        c_api_h.C_LONG_LONG.withName("ri_child_pkg_idle_wkups"),
        c_api_h.C_LONG_LONG.withName("ri_child_interrupt_wkups"),
        c_api_h.C_LONG_LONG.withName("ri_child_pageins"),
        c_api_h.C_LONG_LONG.withName("ri_child_elapsed_abstime"),
        c_api_h.C_LONG_LONG.withName("ri_diskio_bytesread"),
        c_api_h.C_LONG_LONG.withName("ri_diskio_byteswritten"),
        c_api_h.C_LONG_LONG.withName("ri_cpu_time_qos_default"),
        c_api_h.C_LONG_LONG.withName("ri_cpu_time_qos_maintenance"),
        c_api_h.C_LONG_LONG.withName("ri_cpu_time_qos_background"),
        c_api_h.C_LONG_LONG.withName("ri_cpu_time_qos_utility"),
        c_api_h.C_LONG_LONG.withName("ri_cpu_time_qos_legacy"),
        c_api_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_initiated"),
        c_api_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_interactive"),
        c_api_h.C_LONG_LONG.withName("ri_billed_system_time"),
        c_api_h.C_LONG_LONG.withName("ri_serviced_system_time"),
        c_api_h.C_LONG_LONG.withName("ri_logical_writes"),
        c_api_h.C_LONG_LONG.withName("ri_lifetime_max_phys_footprint"),
        c_api_h.C_LONG_LONG.withName("ri_instructions"),
        c_api_h.C_LONG_LONG.withName("ri_cycles"),
        c_api_h.C_LONG_LONG.withName("ri_billed_energy"),
        c_api_h.C_LONG_LONG.withName("ri_serviced_energy"),
        c_api_h.C_LONG_LONG.withName("ri_interval_max_phys_footprint"),
        c_api_h.C_LONG_LONG.withName("ri_runnable_time"),
        c_api_h.C_LONG_LONG.withName("ri_flags"),
        c_api_h.C_LONG_LONG.withName("ri_user_ptime"),
        c_api_h.C_LONG_LONG.withName("ri_system_ptime"),
        c_api_h.C_LONG_LONG.withName("ri_pinstructions"),
        c_api_h.C_LONG_LONG.withName("ri_pcycles"),
        c_api_h.C_LONG_LONG.withName("ri_energy_nj"),
        c_api_h.C_LONG_LONG.withName("ri_penergy_nj"),
        c_api_h.C_LONG_LONG.withName("ri_secure_time_in_system"),
        c_api_h.C_LONG_LONG.withName("ri_secure_ptime_in_system"),
        c_api_h.C_LONG_LONG.withName("ri_neural_footprint"),
        c_api_h.C_LONG_LONG.withName("ri_lifetime_max_neural_footprint"),
        c_api_h.C_LONG_LONG.withName("ri_interval_max_neural_footprint"),
        MemoryLayout.sequenceLayout(9, c_api_h.C_LONG_LONG).withName("ri_reserved")
