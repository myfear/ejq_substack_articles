...
public class sigevent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        c_api_h.C_INT.withName("sigev_notify"),
        c_api_h.C_INT.withName("sigev_signo"),
        sigval.layout().withName("sigev_value"),
        c_api_h.C_POINTER.withName("sigev_notify_function"),
        c_api_h.C_POINTER.withName("sigev_notify_attributes")
    ).withName("sigevent");
    ...
    public final static class sigev_notify_function {
        ...
        private static final MethodHandle UP$MH = c_api_h.upcallHandle(sigev_notify_function.Function.class, "apply", $DESC);
