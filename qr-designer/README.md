...
You can then execute your native executable with: `./target/qr-designer-1.0.0-SNAPSHOT-runner`
...
- Zebra Crossing ([guide](https://docs.quarkiverse.io/quarkus-barcode/dev/index.html)): Zebra Crossing is an open-source, multi-format 1D/2D barcode image processing library.
