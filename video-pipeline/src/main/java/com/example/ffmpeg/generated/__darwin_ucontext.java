...
public class __darwin_ucontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        FFmpeg.C_INT.withName("uc_onstack"),
        FFmpeg.C_INT.withName("uc_sigmask"),
        __darwin_sigaltstack.layout().withName("uc_stack"),
        FFmpeg.C_POINTER.withName("uc_link"),
        FFmpeg.C_LONG.withName("uc_mcsize"),
        FFmpeg.C_POINTER.withName("uc_mcontext")
