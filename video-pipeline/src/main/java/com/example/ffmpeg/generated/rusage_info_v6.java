...
public class rusage_info_v6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, FFmpeg.C_CHAR).withName("ri_uuid"),
        FFmpeg.C_LONG_LONG.withName("ri_user_time"),
        FFmpeg.C_LONG_LONG.withName("ri_system_time"),
        FFmpeg.C_LONG_LONG.withName("ri_pkg_idle_wkups"),
        FFmpeg.C_LONG_LONG.withName("ri_interrupt_wkups"),
        FFmpeg.C_LONG_LONG.withName("ri_pageins"),
        FFmpeg.C_LONG_LONG.withName("ri_wired_size"),
        FFmpeg.C_LONG_LONG.withName("ri_resident_size"),
        FFmpeg.C_LONG_LONG.withName("ri_phys_footprint"),
        FFmpeg.C_LONG_LONG.withName("ri_proc_start_abstime"),
        FFmpeg.C_LONG_LONG.withName("ri_proc_exit_abstime"),
        FFmpeg.C_LONG_LONG.withName("ri_child_user_time"),
        FFmpeg.C_LONG_LONG.withName("ri_child_system_time"),
        FFmpeg.C_LONG_LONG.withName("ri_child_pkg_idle_wkups"),
        FFmpeg.C_LONG_LONG.withName("ri_child_interrupt_wkups"),
        FFmpeg.C_LONG_LONG.withName("ri_child_pageins"),
        FFmpeg.C_LONG_LONG.withName("ri_child_elapsed_abstime"),
        FFmpeg.C_LONG_LONG.withName("ri_diskio_bytesread"),
        FFmpeg.C_LONG_LONG.withName("ri_diskio_byteswritten"),
        FFmpeg.C_LONG_LONG.withName("ri_cpu_time_qos_default"),
        FFmpeg.C_LONG_LONG.withName("ri_cpu_time_qos_maintenance"),
        FFmpeg.C_LONG_LONG.withName("ri_cpu_time_qos_background"),
        FFmpeg.C_LONG_LONG.withName("ri_cpu_time_qos_utility"),
        FFmpeg.C_LONG_LONG.withName("ri_cpu_time_qos_legacy"),
        FFmpeg.C_LONG_LONG.withName("ri_cpu_time_qos_user_initiated"),
        FFmpeg.C_LONG_LONG.withName("ri_cpu_time_qos_user_interactive"),
        FFmpeg.C_LONG_LONG.withName("ri_billed_system_time"),
        FFmpeg.C_LONG_LONG.withName("ri_serviced_system_time"),
        FFmpeg.C_LONG_LONG.withName("ri_logical_writes"),
        FFmpeg.C_LONG_LONG.withName("ri_lifetime_max_phys_footprint"),
        FFmpeg.C_LONG_LONG.withName("ri_instructions"),
        FFmpeg.C_LONG_LONG.withName("ri_cycles"),
        FFmpeg.C_LONG_LONG.withName("ri_billed_energy"),
        FFmpeg.C_LONG_LONG.withName("ri_serviced_energy"),
        FFmpeg.C_LONG_LONG.withName("ri_interval_max_phys_footprint"),
        FFmpeg.C_LONG_LONG.withName("ri_runnable_time"),
        FFmpeg.C_LONG_LONG.withName("ri_flags"),
        FFmpeg.C_LONG_LONG.withName("ri_user_ptime"),
        FFmpeg.C_LONG_LONG.withName("ri_system_ptime"),
        FFmpeg.C_LONG_LONG.withName("ri_pinstructions"),
        FFmpeg.C_LONG_LONG.withName("ri_pcycles"),
        FFmpeg.C_LONG_LONG.withName("ri_energy_nj"),
        FFmpeg.C_LONG_LONG.withName("ri_penergy_nj"),
        FFmpeg.C_LONG_LONG.withName("ri_secure_time_in_system"),
        FFmpeg.C_LONG_LONG.withName("ri_secure_ptime_in_system"),
        FFmpeg.C_LONG_LONG.withName("ri_neural_footprint"),
        FFmpeg.C_LONG_LONG.withName("ri_lifetime_max_neural_footprint"),
        FFmpeg.C_LONG_LONG.withName("ri_interval_max_neural_footprint"),
        MemoryLayout.sequenceLayout(9, FFmpeg.C_LONG_LONG).withName("ri_reserved")
