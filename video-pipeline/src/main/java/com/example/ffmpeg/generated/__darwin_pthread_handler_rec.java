...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        FFmpeg.C_POINTER.withName("__routine"),
        FFmpeg.C_POINTER.withName("__arg"),
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = FFmpeg.upcallHandle(__routine.Function.class, "apply", $DESC);
