...
public class __siginfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        FFmpeg.C_INT.withName("si_signo"),
        FFmpeg.C_INT.withName("si_errno"),
        FFmpeg.C_INT.withName("si_code"),
        FFmpeg.C_INT.withName("si_pid"),
        FFmpeg.C_INT.withName("si_uid"),
        FFmpeg.C_INT.withName("si_status"),
        FFmpeg.C_POINTER.withName("si_addr"),
        sigval.layout().withName("si_value"),
        FFmpeg.C_LONG.withName("si_band"),
        MemoryLayout.sequenceLayout(7, FFmpeg.C_LONG).withName("__pad")
    ).withName("__siginfo");
