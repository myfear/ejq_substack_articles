...
public class __darwin_arm_thread_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(29, FFmpeg.C_LONG_LONG).withName("__x"),
        FFmpeg.C_LONG_LONG.withName("__fp"),
        FFmpeg.C_LONG_LONG.withName("__lr"),
        FFmpeg.C_LONG_LONG.withName("__sp"),
        FFmpeg.C_LONG_LONG.withName("__pc"),
        FFmpeg.C_INT.withName("__cpsr"),
        FFmpeg.C_INT.withName("__pad")
