...
public class __darwin_arm_debug_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, FFmpeg.C_LONG_LONG).withName("__bvr"),
        MemoryLayout.sequenceLayout(16, FFmpeg.C_LONG_LONG).withName("__bcr"),
        MemoryLayout.sequenceLayout(16, FFmpeg.C_LONG_LONG).withName("__wvr"),
        MemoryLayout.sequenceLayout(16, FFmpeg.C_LONG_LONG).withName("__wcr"),
        FFmpeg.C_LONG_LONG.withName("__mdscr_el1")
