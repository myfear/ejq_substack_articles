...
public class rusage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        FFmpeg.C_LONG.withName("ru_maxrss"),
        FFmpeg.C_LONG.withName("ru_ixrss"),
        FFmpeg.C_LONG.withName("ru_idrss"),
        FFmpeg.C_LONG.withName("ru_isrss"),
        FFmpeg.C_LONG.withName("ru_minflt"),
        FFmpeg.C_LONG.withName("ru_majflt"),
        FFmpeg.C_LONG.withName("ru_nswap"),
        FFmpeg.C_LONG.withName("ru_inblock"),
        FFmpeg.C_LONG.withName("ru_oublock"),
        FFmpeg.C_LONG.withName("ru_msgsnd"),
        FFmpeg.C_LONG.withName("ru_msgrcv"),
        FFmpeg.C_LONG.withName("ru_nsignals"),
        FFmpeg.C_LONG.withName("ru_nvcsw"),
        FFmpeg.C_LONG.withName("ru_nivcsw")
    ).withName("rusage");
