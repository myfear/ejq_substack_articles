...
public class sigevent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        FFmpeg.C_INT.withName("sigev_notify"),
        FFmpeg.C_INT.withName("sigev_signo"),
        sigval.layout().withName("sigev_value"),
        FFmpeg.C_POINTER.withName("sigev_notify_function"),
        FFmpeg.C_POINTER.withName("sigev_notify_attributes")
    ).withName("sigevent");
    ...
    public final static class sigev_notify_function {
        ...
        private static final MethodHandle UP$MH = FFmpeg.upcallHandle(sigev_notify_function.Function.class, "apply", $DESC);
