...
public class __sigaction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        FFmpeg.C_POINTER.withName("sa_tramp"),
        FFmpeg.C_INT.withName("sa_mask"),
        FFmpeg.C_INT.withName("sa_flags")
    ...
    public final static class sa_tramp {
        ...
        private static final MethodHandle UP$MH = FFmpeg.upcallHandle(sa_tramp.Function.class, "apply", $DESC);
